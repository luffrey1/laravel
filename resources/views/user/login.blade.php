        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="https://images.unsplash.com/photo-1601645191163-3fc0d5d64e35?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y29taWNzfGVufDB8fDB8fHww"
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              ...
              @csrf
                  ...
                  <label class="form-label" for="form2Example27">Password</label>
                    <input type="password" name="password"  placeholder="Introducir Contraseña"class="form-control form-control-lg" />
